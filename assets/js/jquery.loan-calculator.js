...
;(function ($, window, document, undefined) {
 ...
 // get values and multiply them
        $("form :input").change(function() {
            var value1 = $('form #loan-duration').val();
            var value2 = $('form #loan-amount').val();
            $('form #totalAmounts').val((value1 * value2));
        });
  /**
  ...
  $.extend(Plugin.prototype, {
    ...
    _numberOfPayments: function () {
      // var durationInYears = this._toNumeric(this.settings.loanDuration) / 25;
